...
export default function Landing() {
  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-white font-sans selection:bg-indigo-500/30 overflow-hidden relative">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-[#09090b]/80 backdrop-blur-md border-b border-white/10 py-3' : 'bg-transparent py-5'}`}>
      ...
      <div className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 px-6 md:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-4xl mx-auto">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 mb-8 backdrop-blur-sm animate-fade-in-up">
            ...
            <span className="text-sm font-medium text-gray-300">NovaBoard v2.0 is live</span>
          </div>
          ...
          <p className="mt-6 text-xl text-gray-400 mb-12 max-w-2xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '200ms' }}>
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-5 animate-fade-in-up" style={{ animationDelay: '300ms' }}>
            ...
            <a href="#features" className="px-8 py-4 text-base font-bold text-white bg-white/5 hover:bg-white/10 border border-white/10 rounded-full backdrop-blur-sm transition-all duration-300 flex items-center justify-center gap-2 group">
              Explore Platform
        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 py-10">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center divide-x divide-white/10">
            <div>
              ...
              <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Uptime</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-white mb-2">50k+</div>
              <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Products</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-white mb-2">24/7</div>
              <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Support</div>
            </div>
            <div>
              <div className="text-3xl md:text-4xl font-black text-white mb-2">0ms</div>
              <div className="text-sm font-medium text-gray-400 uppercase tracking-wider">Latency</div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="features" className="py-32 relative">
        <div className="max-w-7xl mx-auto px-6 md:px-12">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            <h2 className="text-3xl md:text-5xl font-extrabold text-white mb-6">Designed for scale. <br/><span className="text-gray-500">Built for speed.</span></h2>
            <p className="text-lg text-gray-400">Everything you need to manage your business efficiently, packaged in a gorgeous, modern interface.</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {/* Feature 1 */}
            <div className="group bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 backdrop-blur-sm relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-indigo-500/20 rounded-full blur-[50px] -mr-10 -mt-10 transition-all group-hover:bg-indigo-500/40"></div>
              ...
              <h3 className="text-2xl font-bold text-white mb-4">Premium Storefront</h3>
              <p className="text-gray-400 leading-relaxed">Give your customers a world-class shopping experience with lightning-fast product loading and seamless checkout flows.</p>
            </div>

            {/* Feature 2 */}
            <div className="group bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 backdrop-blur-sm relative overflow-hidden md:translate-y-8">
              <div className="absolute top-0 right-0 w-32 h-32 bg-purple-500/20 rounded-full blur-[50px] -mr-10 -mt-10 transition-all group-hover:bg-purple-500/40"></div>
              ...
              <p className="text-gray-400 leading-relaxed">Track your business growth in real-time. Make data-driven decisions with powerful admin dashboards and order tracking.</p>
            </div>

            {/* Feature 3 */}
            <div className="group bg-white/5 border border-white/10 p-8 rounded-3xl hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 backdrop-blur-sm relative overflow-hidden">
              <div className="absolute top-0 right-0 w-32 h-32 bg-blue-500/20 rounded-full blur-[50px] -mr-10 -mt-10 transition-all group-hover:bg-blue-500/40"></div>
              ...
              <p className="text-gray-400 leading-relaxed">Rest easy knowing your store is protected by industry-leading security protocols and role-based access controls.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="py-24 relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          <p className="text-xl text-gray-400 mb-10">Join thousands of merchants already using NovaBoard to power their stores.</p>
          <Link to="/login" className="inline-block px-10 py-5 text-lg font-bold text-white bg-white/10 hover:bg-white/20 border border-white/20 rounded-full backdrop-blur-md shadow-2xl transition-all duration-300 hover:scale-105">
